...
public class NotaEstudiante {
    ...
    public void setNota(double nota) {
        System.out.println("SET NOTA " + this.getDNI());
        this.nota = nota;
    ...
    public String toString() {
        return String.format("%s: ", DNI) + (this.presentado ? String.format("%4.2f", nota) : "NP") + String.format("%n") +  " " + this.getConvocatoria() + " " + this.getNota() + " ";
    }
}
