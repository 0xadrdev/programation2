package practica3.ejercicio04; // Indica aquí el nombre del paquete que utilizas.

// Para que este programa de prueba funcione correctamente es importante que
// el método toString() de la clase ListaCadenasEnlaceSimple use el formato
// indicado en el enunciado, es decir:
...
public class ListaCadenasPrueba {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Elemento en la posición " + índice + ": "
                + lista.get(índice));
        ...
        System.out.println("Elemento borrado en la posición 5: " + dato
                + ". Nuevo contenido de la lista: " + lista);

        dato = lista.remove(3);
        comprueba(lista, "[A0, E1, A2, C3]");
        System.out.println("Elemento borrado en la posición 3: " + dato
                + ". Nuevo contenido de la lista: " + lista);

        dato = lista.remove(2);
        comprueba(lista, "[A0, E1, C3]");
        System.out.println("Elemento borrado en la posición 2: " + dato
                + ". Nuevo contenido de la lista: " + lista);
        ...
        System.out.println("------------------------------------------------------------");
        String [] números = new String[] {"uno", "dos", "tres", "cuatro" };
        lista = new ListaCadenasEnlaceSimple();
        ListaCadenas listaNúmeros = new ListaCadenasEnlaceSimple();
